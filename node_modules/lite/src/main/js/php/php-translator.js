...
var XA_TYPE=require('../parse/template-token').XA_TYPE;
var ELSE_TYPE=require('../parse/template-token').ELSE_TYPE;
var EL_TYPE=require('../parse/template-token').EL_TYPE;
var XT_TYPE=require('../parse/template-token').XT_TYPE;

var TranslateContext=require('../parse/translate-context').TranslateContext;
...
var GLOBAL_VAR_MAP=require('../parse/js-translator').GLOBAL_VAR_MAP;
}/*
 * List Template
...
var i18nHash=require('../parse/syntax-i18n').i18nHash;
}