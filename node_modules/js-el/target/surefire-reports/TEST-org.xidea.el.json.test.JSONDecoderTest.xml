...
<testsuite tests="5" failures="0" name="org.xidea.el.json.test.JSONDecoderTest" time="0.002" errors="0" skipped="0">
  <properties>
...
"/>
  ...
  <testcase classname="org.xidea.el.json.test.JSONDecoderTest" name="testDecodeList" time="0"/>
  <testcase classname="org.xidea.el.json.test.JSONDecoderTest" name="testJSEL" time="0"/>
  <testcase classname="org.xidea.el.json.test.JSONDecoderTest" name="testDecodeObject" time="0.001"/>
  <testcase classname="org.xidea.el.json.test.JSONDecoderTest" name="testEncodeObject" time="0"/>
  <testcase classname="org.xidea.el.json.test.JSONDecoderTest" name="testG" time="0.001"/>
</testsuite>